    ...
    try {
        ...
        if (type === 'administradores') {
            ...
            if (mirror) {
                ...
                const stale = local.filter(d => !target.has(normalize(d.nombre)) && normalize(d.nombre) !== normalize(DEMO_DEPENDENCIA) && normalize(d.nombre) !== normalize(DEMO_DEPENDENCIA_2));
